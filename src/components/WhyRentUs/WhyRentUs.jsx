    ...
    <section className="py-24 relative overflow-hidden bg-base-200">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="md:col-span-2 group/card glass-card p-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8 bg-white/60 dark:bg-white/5 border border-white/20 dark:border-white/5 rounded-3xl relative overflow-hidden hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5">
            <div className="relative z-10 space-y-4 max-w-md">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white group-hover/card:text-primary transition-colors">
          ...
          <div className="group/card glass-card p-8 bg-white/60 dark:bg-white/5 border border-white/20 dark:border-white/5 rounded-3xl hover:-translate-y-1 transition-all duration-300 hover:shadow-lg">
